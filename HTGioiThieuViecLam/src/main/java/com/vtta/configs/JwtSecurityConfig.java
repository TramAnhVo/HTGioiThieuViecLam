...
import com.vtta.filters.CustomAccessDeniedHandler;
import com.vtta.filters.JwtAuthenticationTokenFilter;
import com.vtta.filters.RestAuthenticationEntryPoint;
...
public class JwtSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        ...
        http.authorizeRequests().antMatchers("/api/jobs/").permitAll();
        http.authorizeRequests().antMatchers("/api/jobs/**").permitAll();
